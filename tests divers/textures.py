...
button_sound_off = button_sound.subsurface((0, 0, width_button_sound // 2, height_button_sound))
button_sound_on = button_sound.subsurface((width_button_sound // 2, 0, width_button_sound // 2, height_button_sound))
button_sound_off_rect = button_sound_off.get_rect()
button_sound_off_rect = button_sound_off_rect.move(230,420)
#bouton son no
